        ...
        <div className='modal-container' >
          <form encType="multipart/form-data" >
            ...
            <div className='form-body'>
              ...
              <FormGroup label="Avatar" accept='image/*' type='file' name="avatar" onChange={e => handleAvatar(e)} style={{height: 40, width: 84, display: 'block', padding: 5  }} ></FormGroup>
              <span style={{color:'red',opacity: 0.9,height:10,display:'inline-block'}}>{props.errors.avatar}</span>
              <img alt='' src={props.previewImage ? props.previewImage : process.env.REACT_APP_API_URL+"/avatar/"+ props.editingStudent?.avatar} style={{width: 70, display: 'block',height:70 }} ></img>
